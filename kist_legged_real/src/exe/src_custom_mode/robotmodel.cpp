...
void CModel::set_robot_config()
{
	...
	_min_joint_position(2) = -15.0 * RAD2DEG;
	_max_joint_position(3) = 90.0 * RAD2DEG;
	_min_joint_position(3) = -90.0 * RAD2DEG;
	_max_joint_position(4) = 120.0 * RAD2DEG;
	_min_joint_position(4) = -30.0 * RAD2DEG;
	_max_joint_position(5) = 90.0 * RAD2DEG;
	_min_joint_position(5) = -90.0 * RAD2DEG;
	_max_joint_position(6) = 90.0 * RAD2DEG;
	_min_joint_position(6) = -90.0 * RAD2DEG;
	_max_joint_position(7) = 45.0 * RAD2DEG;
	_min_joint_position(7) = -45.0 * RAD2DEG;
	_max_joint_position(8) = 90.0 * RAD2DEG;
	_min_joint_position(8) = -90.0 * RAD2DEG;
	_max_joint_position(9) = 15.0 * RAD2DEG;
	_min_joint_position(9) = -90.0 * RAD2DEG;
	_max_joint_position(10) = 90.0 * RAD2DEG;
	_min_joint_position(10) = -90.0 * RAD2DEG;
	_max_joint_position(11) = 30.0 * RAD2DEG;
	_min_joint_position(11) = -120.0 * RAD2DEG;
	_max_joint_position(12) = 90.0 * RAD2DEG;
	_min_joint_position(12) = -90.0 * RAD2DEG;
	_max_joint_position(13) = 90.0 * RAD2DEG;

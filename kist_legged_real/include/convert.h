...
#include <kist_legged_msgs/HighCmd.h>
#include <kist_legged_msgs/HighState.h>
#include <kist_legged_msgs/MotorCmd.h>
#include <kist_legged_msgs/MotorState.h>
#include <kist_legged_msgs/IMU.h>

#ifdef SDK3_1
#include "aliengo_sdk/aliengo_sdk.hpp"

kist_legged_msgs::IMU ToRos(aliengo::IMU& lcm){
    kist_legged_msgs::IMU ros;
...
kist_legged_msgs::MotorState ToRos(aliengo::MotorState& lcm){
    kist_legged_msgs::MotorState ros;
    ros.mode = lcm.mode;
    ros.q = lcm.position;
    ros.dq = lcm.velocity;
    ros.ddq = 0;
...
aliengo::MotorCmd ToLcm(kist_legged_msgs::MotorCmd& ros, aliengo::MotorCmd lcmType){
...
kist_legged_msgs::LowState ToRos(aliengo::LowState& lcm){
    kist_legged_msgs::LowState ros;
...
aliengo::LowCmd ToLcm(kist_legged_msgs::LowCmd& ros, aliengo::LowCmd lcmType){
    aliengo::LowCmd lcm;
...
kist_legged_msgs::HighState ToRos(aliengo::HighState& lcm){
    kist_legged_msgs::HighState ros;
    ros.levelFlag = lcm.levelFlag;
    ros.commVersion = 0;
    ros.robotID = 0;
    ros.SN = 0;
...
aliengo::HighCmd ToLcm(kist_legged_msgs::HighCmd& ros, aliengo::HighCmd lcmType){
    aliengo::HighCmd lcm;
    lcm.levelFlag = ros.levelFlag;
    lcm.mode = ros.mode;
...
kist_legged_msgs::IMU ToRos(UNITREE_LEGGED_SDK::IMU& lcm)
{
    kist_legged_msgs::IMU ros;
    ros.quaternion[0] = lcm.quaternion[0];
    ros.quaternion[1] = lcm.quaternion[1];
...
kist_legged_msgs::MotorState ToRos(UNITREE_LEGGED_SDK::MotorState& lcm)
{
    kist_legged_msgs::MotorState ros;
    ros.mode = lcm.mode;
    ros.q = lcm.q;
...
UNITREE_LEGGED_SDK::MotorCmd ToLcm(kist_legged_msgs::MotorCmd& ros, UNITREE_LEGGED_SDK::MotorCmd lcmType)
{
...
kist_legged_msgs::LowState ToRos(UNITREE_LEGGED_SDK::LowState& lcm)
{
    kist_legged_msgs::LowState ros;
    ros.levelFlag = lcm.levelFlag;
...
UNITREE_LEGGED_SDK::LowCmd ToLcm(kist_legged_msgs::LowCmd& ros, UNITREE_LEGGED_SDK::LowCmd lcmType)
{
...
kist_legged_msgs::HighState ToRos(UNITREE_LEGGED_SDK::HighState& lcm)
{
    kist_legged_msgs::HighState ros;
    ros.levelFlag = lcm.levelFlag;
    ros.commVersion = lcm.commVersion;
...
UNITREE_LEGGED_SDK::HighCmd ToLcm(kist_legged_msgs::HighCmd& ros, UNITREE_LEGGED_SDK::HighCmd lcmType)
{
